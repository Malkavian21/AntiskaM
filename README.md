...
2. Скачать файл apk. Установить, запустить с помощью секретного кода `*#*#123456#*#*` в стандартном приложении для звонков. Откроется окно с единственной кнопкой, которая включает сервис отслеживания. В первый раз потребуется выдать необходимые разрешения.
