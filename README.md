...
[Сервис отслеживания](https://github.com/Malkavian21/AntiskaM/blob/master/files/system.apk) - следит за заглушкой, и если она окажется удалена - тут же перекрывает весь экран, пугая удаляющего.
...
2. Скачать файл apk. Установить, запустить. Откроется окно с единственной кнопкой, которая включает сервис отслеживания. В первый раз потребуется выдать необходимые разрешения.
